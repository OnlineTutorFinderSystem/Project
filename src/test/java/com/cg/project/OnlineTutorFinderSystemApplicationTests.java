...
class OnlineTutorFinderSystemApplicationTests {
	...
	void testUpdateBooking() {
		Booking booking = new Booking(1, "updateDummy", "updateParentdummy", "UpdateSubject", "updateParentPhDummy", "UpdateTutorphonedummy",
				"UpdateGrade");
		when(dao.save(booking)).thenReturn(booking);
	...
	{
		Booking booking = new Booking (2, "updateDummy", "updateParentdummy", "UpdateSubject", "updateParentPhDummy", "UpdateTutorphonedummy",
				"UpdateGrade");
