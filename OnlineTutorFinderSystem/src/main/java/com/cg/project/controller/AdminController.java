...
public class AdminController {
	...
	public Admin addAdmin(@RequestBody Admin admin) { // method to call addAdmin method from service layer
	...
	public Admin updateAdmin(@RequestBody Admin admin) { // method to call update Admin method from service layer
	...
	public String deleteAdmin(@PathVariable("adminId") int adminId) {// method to call deleteAdmin method from service
																		// layer
	...
	public Optional<Admin> getAdminById(@PathVariable("adminId") int adminId) {// method to call getAdminById method
																				// from service layer
	...
	public List<Admin> fetchAllByAdminName(@PathVariable("adminName") String adminName) {// method to call
																							// getAllByAdminName method
																							// from service layer
	...
	public Admin fetchByAdminEmailId(@PathVariable("adminEmailId") String adminEmailId) {// method to call
																							// getByAdminByEmailId
	...
	public Admin fetchByAdminPhoneNo(@PathVariable("adminPhoneNo") String adminPhoneNo) {// method to call
																							// getByAdminPhoneNo method
																							// from service layer
	...
	public List<Admin> fetchAllAdmins() {// method to call getAllAdmins method from service layer
